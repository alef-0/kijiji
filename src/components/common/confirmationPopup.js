        ...
        return (
            <div className="vme-alert vme-alert--warning vme-alert-success">
                <div className="vme-alert__content">
                    Your identity has been confirmed through <strong>Verified.Me</strong>, and other users will now see this on your profile summary. Click "My Ads" to see your <a href="#">existing</a> postings, or to add create a new listing.</div>
